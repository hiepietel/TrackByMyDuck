...
{
    public class FacebookLogInCommandHandler : IRequestHandler<FacebookLogInCommand, FacebookUserVm>
    {
        private readonly IAuthService _authService;
        private readonly IUserRepository _usersRepository;
        private readonly IMapper _mapper;
        public FacebookLogInCommandHandler(IAuthService authService, IUserRepository usersRepository, IMapper mapper)
        {
        ...
        public async Task<FacebookUserVm> Handle(FacebookLogInCommand request, CancellationToken cancellationToken)
        {
            ...
            var userVm = _mapper.Map<FacebookUserVm>(user);
